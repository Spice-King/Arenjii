...
{
    // const rolls = [];
    const rollCount = new Array(7).fill(0);
    ...
    robot.registerCommand(/stats/i, `\`${robot.config.prefix[1]}stats\` prints out dice statistics`, (message) => 
    {
        // console.log(rolls);
        // console.log(rollCount);
        let lines = [];
        let largest = 0;
        rollCount.find((num) => {if (num>largest) {largest = num}});
